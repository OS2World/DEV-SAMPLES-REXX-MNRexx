...
BOOL    fExitMessage = FALSE;           /* MN: if false, don't show exit message */
                                        /* MN: controllable by '/e' option */
...
void main(LONG argc, CHAR *argv[])
{
  ...
  if (argc > argnum && (!strcmp("/t", argv[argnum]) || !strcmp("/T", argv[argnum]))) {
  ...
  if (argc > argnum && (!strcmp("/e", argv[argnum]) || !strcmp("/E", argv[argnum]))) {

    fExitMessage = TRUE;                      /* Set the exit message flag                  */
    argnum++;                          /* If it was, that's an extra arg to   */
                                       /* skip                                */
  }
